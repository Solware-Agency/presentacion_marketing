...
export function SlideTitle({ title, subtitle }: SlideTitleProps) {
	return (
		<div className="text-center w-full px-4 pt-4 sm:pt-6 md:pt-8 mb-6 sm:mb-8">
			<h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4" style={{ color: '#41e2b8' }}>{title}</h1>
			...
			{subtitle && (
				<>
					<h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-4" style={{ color: '#41e2b8' }}>{subtitle}</h2>
				</>
			)}
		</div>
	)
