...
export function QuienEsSolware() {
	return (
		<div className="bg-gradient-to-br from-[#1e0c2f] via-[#2a1350] to-[#4b1c7a] w-screen h-screen flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 overflow-hidden relative">
			<LogoCorner />
			<SlideTitle title="¿Quién es Solware Agency?" />

			<div className="max-w-6xl w-full space-y-4 sm:space-y-6 md:space-y-8 px-4">
				<AnimatedText delay={0.2}>
					<p className="text-white/90 text-base sm:text-lg md:text-xl lg:text-2xl text-center leading-relaxed mb-4 sm:mb-6 md:mb-8 font-bold">
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mt-6 sm:mt-8 md:mt-12">
					<AnimatedCard delay={0.4} className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-5 md:p-6 border border-white/20">
						...
						<p className="text-white text-sm sm:text-base md:text-lg leading-relaxed font-bold">
